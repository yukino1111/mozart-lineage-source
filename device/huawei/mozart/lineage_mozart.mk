...
MOZART_BUILD_ID ?= RQ3A.211001.001
MOZART_FINGERPRINT_ID ?= RQ3A.211001.001
...
MOZART_BUILD_DESC := lineage_mozart-user 11 $(MOZART_BUILD_ID) $(MOZART_BUILD_NUMBER) release-keys
...
BUILD_FINGERPRINT := huawei/mozart/hi3635:11/$(MOZART_FINGERPRINT_ID)/$(MOZART_BUILD_NUMBER):user/release-keys
